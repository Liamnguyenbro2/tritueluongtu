...
class AdminPlanManagementTest extends TestCase
{
    ...
    public function test_admin_can_update_plan_pricing_copy_and_payment_methods(): void
    {
        $this->seed();
    ...
    public function test_billing_page_uses_plan_copy_and_blocks_disabled_payment_methods(): void
    {
        $this->seed();
